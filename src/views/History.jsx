    ...
    return (
        <>
            ...
            <main>
                ...
                <div className="row text-body mx-auto">
                    <img className="col-md-12 img-fluid rounded my-4" src={GapanMap} alt="" />
					<figure className="text-justify mx-auto">
						<blockquote className="blockquote long-text">
							<p>
